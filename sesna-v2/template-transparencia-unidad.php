        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-5 tx-unidad-card">
            <div class="row g-0">
                ...
                <div class="col-lg-6 p-4 p-md-5 d-flex flex-column justify-content-center">
                    <p class="font-noto-sans text-dark mb-4 fs-5" style="line-height: 1.6;">
                    ...
                    <div class="d-flex flex-column gap-4">
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h5 class="font-noto-sans fw-bold mb-1 text-burgundi h5">Dirección:</h5>
                                <p class="font-noto-sans text-dark mb-0 fs-6">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="font-noto-sans fw-bold mb-1 text-burgundi h5">Teléfono:</h5>
                                <a href="tel:5581178100" class="font-noto-sans text-dark text-decoration-none fs-6">558117-8100 ext.1116</a>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h5 class="font-noto-sans fw-bold mb-1 text-burgundi h5">Horarios:</h5>
                                <p class="font-noto-sans text-dark mb-0 fs-6">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="font-noto-sans fw-bold mb-1 text-burgundi h5">Correo Electrónico:</h5>
                                <a href="mailto:unidadtransparencia@sesna.gob.mx" class="font-noto-sans text-dark text-decoration-none fs-6">unidadtransparencia@sesna.gob.mx</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 p-4 p-md-5 d-flex align-items-stretch">
                    <div class="w-100 h-100 rounded-4 overflow-hidden position-relative shadow-sm" style="min-height: 450px; background-color: #eee;">
            ...
            <div class="position-relative d-flex align-items-center px-4 px-md-5 py-4 mt-2" style="background-color: #fbf4f5; overflow: hidden;">
                <div class="d-flex align-items-center position-relative z-1" style="max-width: 80%;">
                    ...
                    <p class="font-noto-sans mb-0 fw-medium text-dark fs-6">

<div class="blogEntriesList">
    <div class="entryContainer2">
        ...
        <?php else: ?>
            <img class="featured" src="<?php bloginfo('stylesheet_directory') ?>/img/blog/featuredText.jpg" alt="featured"/>
        <?php endif; ?>

        </div>
        <h1 class="tituloEntry"><?php the_title(); ?></h1>
        <div class="d-flex">
            <div class="p-2"><img src="<?php bloginfo('stylesheet_directory') ?>/img/blog/entrada_texto.png" alt="lineas"></div>
